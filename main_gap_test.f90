program main
    ...
    double precision,parameter :: a_min_ini = 1e-5
    ...
    call read_static_gas_disk("gap_test_sim.csv", nrows,10,R,OmegaK,Sigma,cs,H_gas,T,mump,mfp,eta,P)
    ...
    do while(.true.)
        ...
        !timestep_lim = max(timestep_lim,1e-2*an)
